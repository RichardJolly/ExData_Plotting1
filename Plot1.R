...
# Open a png graphics device which creates a 480x480 pixel file named Plot1.png
png(filename = "Plot1.png",width = 480, height = 480, units = "px")
# Create a histogram of Global Active Power
hist(powerConsumptionSubset.dt$Global_active_power,main="Global Active Power",xlab="Global Active Power(kilowatts)",col="red")
